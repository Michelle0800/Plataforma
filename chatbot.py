...
# ======================
class Config:
    API_KEY = "AIzaSyBCRv6cub7dVuS5SwHttp2cfHQHfrpULHY"
        ...
        plans = [
            {
                ...
                "tag": "COMUM",
                "link": Config.CHECKOUT_DIABINHA_SECRETO + "?plan=1mes"
            },
            {
                "name": "3 Meses",
                "price": "R$ 69,90",
                ...
                "tag": "MAIS POPULAR",
                "link": Config.CHECKOUT_DIABINHA_SECRETO + "?plan=3meses"
            },
            {
                "name": "1 Ano",
                "price": "R$ 199,90",
                ...
                "link": Config.CHECKOUT_DIABINHA_SECRETO + "?plan=1ano"
            }
        ]
